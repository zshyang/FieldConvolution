...
class Net(nn.Module):
    ...
    def forward(self, batch: dict) -> dict:
        ...
        field_feature = F.relu(self.fbn(field_feature))

        field_feature = self.sa1_conv1(field_feature)
        field_feature = F.relu(self.fbn1(field_feature))
        field_feature = self.sa1_conv2(field_feature)
        field_feature = F.relu(self.fbn2(field_feature))
        field_feature = self.sa1_conv3(field_feature)
        field_feature = F.relu(self.fbn3(field_feature))
