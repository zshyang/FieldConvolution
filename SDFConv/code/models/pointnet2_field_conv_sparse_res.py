    ...
    def __init__(self, options: EasyDict):
        ...
        self.sparseModel = scn.Sequential(
            scn.SubmanifoldConvolution(
                dimension=3, nIn=1, nOut=16,
                filter_size=3, bias=False
            ),
            ...
            scn.Convolution(
                dimension=3, nIn=96, nOut=128,
                filter_size=3, filter_stride=1, bias=False
            ),
        ...
        self.input_layer = scn.InputLayer(
            3, options.model.input_size, mode=4
        )
...
def test():
    ...
    batch = {
        ...
        "xyz_sdf": torch.randn(dim_b, dim_n, 4).cuda(),
    }
    ...
    options.model.input_size = 511
    gkcnet = Net(options).cuda()
    # print(i)
